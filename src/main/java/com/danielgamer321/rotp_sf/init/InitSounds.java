...
public class InitSounds {
    ...
    public static final Supplier<SoundEvent> STONE_FREE_PUNCH_LIGHT = ModSounds.STAND_PUNCH_LIGHT;
    
    public static final Supplier<SoundEvent> STONE_FREE_PUNCH_HEAVY = ModSounds.STAND_PUNCH_HEAVY;
    
    public static final Supplier<SoundEvent> STONE_FREE_BARRAGE = ModSounds.STAND_PUNCH_LIGHT;
